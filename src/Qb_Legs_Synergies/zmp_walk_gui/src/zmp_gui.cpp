...
//   err_tilde_sub=n.subscribe("/bias_trunk_ankles",10,&qt_example::Retrieve_Err_Tilde,this);
  ...
  dataset_name_sub_1=n.subscribe("/zmp_walk/dataset_name",10,&qt_example::Retrieve_names_optimal,this);
...
//   pub_ddes=n.advertise<std_msgs::Float32>("/update_d_des",10);
  ...
  pub_start=n.advertise<std_msgs::Float64>("/zmp_walk/start",10);
    ...
    QImage myImage;
	myImage.load(QString::fromStdString(ros::package::getPath("zmp_walk_gui")+"/ZMP_SoftLegs_GUI.png"));
...
//     button_8.setText("Kill ZMP");
    ...
    connect(&button_3,SIGNAL(clicked(bool)),this,SLOT(on_button_clicked_launch_zmp()));
    connect(&button_4,SIGNAL(clicked(bool)),this,SLOT(on_button_clicked_kill_zmp()));    
...
//     biasLineEdit_write->setInputMask("xxx,xxx,xxx,xxx,xxx,xxx");
    biasLineEdit_write->setText("-18,0,24,0,0,17"); //-1,0,15,-3,0,16

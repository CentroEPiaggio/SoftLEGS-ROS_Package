...
void qt_example::Retrieve_names_optimal(const optimal_walk_gui::dataset_name& msg)
{
...
void qt_example::Retrieve_names_zmp(const optimal_walk_gui::dataset_name& msg)
{
if(msg.name_list.size()<=0 || OptList==NULL){return;}

...
bool setSimCallback(optimal_walk::num_sim_srv::Request& request, optimal_walk::num_sim_srv::Response& response)
{
...
void TeleCallback(const std_msgs::Char& msg){
  switch(msg.data){
    
    case 'U':
      ROS_INFO("Tele Increase");
      Des_Optimal_sim+=1;
      break;
    case 'D':
      ROS_INFO("Tele Decrease");
      Des_Optimal_sim-=1;
...
void DecreaseDesOptCallback(const std_msgs::Float32::ConstPtr& msg){
  Des_Optimal_sim-=1;
...
bool setSimStartCallback(optimal_walk::sim_start_srv::Request& request, optimal_walk::sim_start_srv::Response& response)
{
   ROS_INFO("Warm_Start");
   Warm_Start=true;
...
bool setSimStopCallback(optimal_walk::sim_stop_srv::Request& request,optimal_walk::sim_stop_srv::Response& response)
{
   ROS_INFO("Warm_Stop");

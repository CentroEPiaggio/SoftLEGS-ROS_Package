...
struct st_mem {
    ...
    uint8   acc_unity;                  // Acc unity index
    uint8   gyro_unity;                 // Gyro unity index
    uint8   mag_unity;                  // Mag unity idx
    
    uint8   acc_sf;                     // Acc Full Range Scale index
    uint8   gyro_sf;                    // Gyro Full Range Scale index
};
...
// Full Range Scale registers
extern int frsAccReg;       
extern int frsGyroReg;
extern uint8   rateAcc;                    // Acc ticks to g conversion factor
extern uint8   rateGyro;                   // Gyro ticks to deg/s conversion factor

// Scale Factors
#define ACC_SF      0.000061037
#define GYRO_SF     0.007629627
#define MAG_SF      0.1465

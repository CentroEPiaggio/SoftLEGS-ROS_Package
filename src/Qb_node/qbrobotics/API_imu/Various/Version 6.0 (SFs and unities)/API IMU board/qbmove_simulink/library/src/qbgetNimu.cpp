...
#define S_FUNCTION_NAME  qbgetNimu
...
#define out_n_imu         ( ssGetOutputPortRealSignal       ( S, 0 ) )
...
///////////////////////////////// 3 ) com handle    ////////////////////////////
            ...
            ssSetOutputPortDataType( S, 1, COM_HANDLE_id );
        }
        else
        {
...
//============================================================      qbot ID check
     ...
     out_n_imu[i]    = dwork_out(i)[0];

     if(!commGetNImu(&comm_settings_t, qbot_id, &n_imu))
     {
         out_n_imu[i] = (uint8_T) n_imu;
         
         dwork_out(i)[0] = out_n_imu[i];
     }
    }

        ...
        if (get_or_set == 's') {
            switch(i_choice) {
                ...
                case 3:
                    ...
                    commSetParam(&comm_settings_t, BROADCAST_ID,
                        PARAM_PID_CURR_CONTROL, pid_control, 3);
                    break;
                ...
                case 5:
                    ...
                    commSetParam(&comm_settings_t, BROADCAST_ID,
                        PARAM_CONTROL_MODE, &control_mode, 1);
                ...
                case 6:
                    ...
                    commSetParam(&comm_settings_t, BROADCAST_ID,
                        PARAM_POS_RESOLUTION, resolution, NUM_OF_SENSORS);
                    break;
                ...
                case 8:
                    ...
                    commSetParam(&comm_settings_t, BROADCAST_ID,
                        PARAM_MEASUREMENT_MULTIPLIER, multipliers, NUM_OF_SENSORS);
                    break;
                ...
                case 9:
                    ...
                    commSetParam(&comm_settings_t, BROADCAST_ID,
                        PARAM_POS_LIMIT_FLAG, &aux_int, 1);
                    break;
                ...
                case 10:
                    ...
                    scanf("%hd", pos_limits);
                    printf("\nSup limit 1: ");
                    scanf("%hd", pos_limits + 1);
                    printf("\nInf limit 2: ");
                    scanf("%hd", pos_limits + 2);
                    printf("\nSup limit 2: ");
                    scanf("%hd", pos_limits + 3);

                    commSetParam(&comm_settings_t, BROADCAST_ID,
                        PARAM_POS_LIMIT, pos_limits, 4);
                    break;
                ...
                case 12:
                    ...
                    commSetParam(&comm_settings_t, BROADCAST_ID,
                        PARAM_CURRENT_LIMIT, &current_limit, 1);
                    break;

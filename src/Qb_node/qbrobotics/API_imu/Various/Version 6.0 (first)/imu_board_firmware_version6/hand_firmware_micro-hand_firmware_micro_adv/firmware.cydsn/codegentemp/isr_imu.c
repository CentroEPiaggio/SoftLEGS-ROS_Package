...
extern uint8 IMU_conf[N_IMU_MAX][3];
    ...
    if (imu_send_flag == 1){
        ...
        {	
            ...
            if (IMU_conf[IMU_connected[k_imu]][0]){
                single_packet[c]   = (uint8) Accel[IMU_connected[k_imu]][0];
                single_packet[c+1] = (uint8) Accel[IMU_connected[k_imu]][1];
                single_packet[c+2] = (uint8) Accel[IMU_connected[k_imu]][2];
                single_packet[c+3] = (uint8) Accel[IMU_connected[k_imu]][3];
                single_packet[c+4] = (uint8) Accel[IMU_connected[k_imu]][4];
                single_packet[c+5] = (uint8) Accel[IMU_connected[k_imu]][5];
                c = c + 6;
            }
            if (IMU_conf[IMU_connected[k_imu]][1]){
                single_packet[c]   = (uint8) Gyro[IMU_connected[k_imu]][0];
                single_packet[c+1] = (uint8) Gyro[IMU_connected[k_imu]][1];
                single_packet[c+2] = (uint8) Gyro[IMU_connected[k_imu]][2];
                single_packet[c+3] = (uint8) Gyro[IMU_connected[k_imu]][3];
                single_packet[c+4] = (uint8) Gyro[IMU_connected[k_imu]][4];
                single_packet[c+5] = (uint8) Gyro[IMU_connected[k_imu]][5];
                c = c + 6;
            }
            if (IMU_conf[IMU_connected[k_imu]][2]){
                single_packet[c]   = (uint8) Mag[IMU_connected[k_imu]][0];
                single_packet[c+1] = (uint8) Mag[IMU_connected[k_imu]][1];
                single_packet[c+2] = (uint8) Mag[IMU_connected[k_imu]][2];
                single_packet[c+3] = (uint8) Mag[IMU_connected[k_imu]][3];
                single_packet[c+4] = (uint8) Mag[IMU_connected[k_imu]][4];
                single_packet[c+5] = (uint8) Mag[IMU_connected[k_imu]][5];
                c = c + 6;
            }
